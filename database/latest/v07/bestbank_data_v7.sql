...
INSERT INTO `account` VALUES (100000000,0,'2019-11-27','Rockerfeller Bank'),(100000001,0,'2019-09-02','Oakmont Bank'),(100000002,0,'2019-11-28','Sun Bank'),(100000003,-300,'2019-10-21','Oakmont Bank'),(100000004,0,'2019-12-02','Rockerfeller Bank');
...
INSERT INTO `dependent` VALUES ('Richman','Jenny','999-88-7777');
...
INSERT INTO `employee` (`ssn`, `manager_ssn`, `start_date`, `phone_no`, `branch_name`, `position`) VALUES ('112-98-1507','227-65-3915','2017-02-15','846-234-5891','Oakmont Bank','Customer Rep'),('227-65-3915','999-88-7777','2008-10-11','222-867-5309','Oakmont Bank','Manager'),('229-64-2379','321-68-9764','2012-01-05','202-467-9273','Rockefeller Bank','Customer Rep'),('321-68-9764','999-88-7777','2002-12-17','343-500-1264','Rockerfeller Bank','Manager'),('568-25-9875','659-98-7533','2010-08-05','732-555-9845','Sun Bank','Customer Rep'),('659-98-7533','999-88-7777','2005-04-13','647-569-3486','Sun Bank','Manager'),('678-95-1374','227-65-3915','2018-06-07','846-234-6671','Oakmont Bank','Customer Rep'),('999-88-7777','999-88-7777','2000-01-01','647-318-2264','Rockerfeller Bank','CEO');
...
INSERT INTO `transaction` VALUES (1,100000000,'BF','2019-10-01','10:10 AM',1000000),(2,100000001,'BF','2019-10-02','11:11 AM',50000),(3,100000002,'BF','2019-10-03','12:12 PM',55000),(4,100000003,'BF','2019-10-04','10:55 AM',500),(5,100000004,'BF','2019-10-04','04:20 PM',9000),(6,100000000,'CD','2019-10-05','6:00 PM',250000),(7,100000003,'WD','2019-10-21','11:00 AM',777.49),(8,100000001,'WD','2019-10-21','1:30 PM',250),(9,100000000,'SC','2019-11-01','6:00 AM',2),(10,100000001,'SC','2019-11-01','6:00 AM',2),(11,100000002,'SC','2019-11-01','6:00 AM',2),(12,100000003,'SC','2019-11-01','6:00 AM',2),(13,100000004,'SC','2019-11-01','6:00 AM',2),(14,100000002,'CD','2019-11-02','10:01 AM',450),(15,100000000,'WD','2019-11-11','11:11 AM',5500.55);
...
-- Dump completed on 2019-12-04 23:21:06
